...
modulation produced by a trained hypernetwork, our own intervention, held to the same
instrument, in matched pairs where the representation of the commitment is the only variable
...
to chance (\(0.68\to0.48\)), and what separates the two cases is unresolved
